...
from .services import default_triage_services as build_default_triage_services
from .workflow import run_triage_workflow as run_plan_triage_workflow
...
def cmd_plan_triage(args: argparse.Namespace) -> None:
    ...
    triage_services = build_default_triage_services()
    run_plan_triage_workflow(
        args,
